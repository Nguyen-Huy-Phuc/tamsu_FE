    ...
    <>
      ...
      <div 
        ...
        style={{
          ...
          padding: 0,
          zIndex: 9999,
          background: 'linear-gradient(135deg, rgb(88, 28, 135) 0%, rgb(91, 33, 182) 50%, rgb(251, 146, 60) 100%)',
          overflow: 'hidden',
      ...
      <div 
        style={{
          ...
          width: '192px',
          height: '192px',
          background: 'linear-gradient(135deg, rgb(253, 186, 116) 0%, rgb(251, 146, 60) 100%)',
          borderRadius: '50%',
          opacity: 0.8,
          filter: 'blur(48px)',
          pointerEvents: 'none'
      ...
      <div 
        style={{
          ...
          width: '256px',
          height: '256px',
          background: 'linear-gradient(135deg, rgb(244, 114, 182) 0%, rgb(251, 146, 60) 100%)',
          borderRadius: '50%',
          opacity: 0.6,
          filter: 'blur(64px)',
          pointerEvents: 'none'
